...
- [x] 版本号：2.2.0（语义化版本；与 `manifest.json` 一致）
...
### 8. 打包准备 ✅
- [x] 清理发布构建目录中的临时文件
- [x] 压缩为 ZIP：`dist/page-scroll-master-v2.2.0.zip`
- [x] ZIP 包大小 < 2MB（185975 bytes）
- [x] 所有必要文件都包含
- [x] 无多余文件
- [x] 文件结构正确，`unzip -t` 通过
...
2. **版本号策略**：以 `manifest.json` 中的版本号为准，v2.2 发布目标为 2.2.0
3. **描述优化**：使用关键词，提高搜索排名
...
**最后更新时间**：2026-06-15
**状态**：v2.2.0 发布文件同步、完整构建、源码与打包后回归及 ZIP 校验均已完成
**构建产物**：`dist/page-scroll-master-v2.2.0.zip`，SHA-256 `7bb85ecf0e69fb088112ee5741580cfa858c4d0e819512711d7723670b0de537`
**验收说明**：v2.2 真实扩展小时级限流验证和 Chrome Web Store 反馈数据披露仍待人工完成
