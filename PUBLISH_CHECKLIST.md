...
### 1. 元数据准备 ✅
- [ ] 英文插件名称：One Click Top & Bottom – Fast Page Scroll（45字符以内）
- [ ] 中文插件名称：一键顶部/底部滚动
- [ ] 简短描述：一键滚动到页面顶部及底部的浏览器插件（85字符以内）
...
2. **版本号策略**：以 `manifest.json` 中的版本号为准，当前为 1.7.0
3. **描述优化**：使用关键词，提高搜索排名
